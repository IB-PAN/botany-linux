...
tar -xaf /tmp/ookla-speedtest.tgz -C /usr/bin speedtest
tar -xaf /tmp/ookla-speedtest.tgz -C /usr/share/man/man5 speedtest.5
mkdir -p /usr/share/doc/speedtest
tar -xaf /tmp/ookla-speedtest.tgz -C /usr/share/doc/speedtest speedtest.md
