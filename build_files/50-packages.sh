...
pdnf install screen signon-kwallet-extension signon-ui tecla gphoto2 v4l-utils xlsclients nodejs \
    ...
    kcalc gwenview okular kweather krecorder haruna kolourpaint kcolorchooser kcharselect qdirstat kdiskmark filelight cpu-x audacity diffpdf \
    ...
    samba samba-tools \
    gparted gsmartcontrol btrfs-assistant btrfsmaintenance snapper xfsprogs-xfs_scrub duperemove fdupes ncdu sysstat ntfs2btrfs \
    dialog freerdp git iproute libnotify nmap-ncat iperf3 podman-compose xdg-native-messaging-proxy \
